...
function ConfirmDeleteHabit({ handleDeleteHabit, setDeleteHabitPopup, idToDelete, habits }) {
    ...
    <div className='overlay'>
        <div className='delete-confirm-container'>
            ...
            <div className='action-buttons-div'>
                ...
                <button onClick={() => setDeleteHabitPopup(false)} className='cancel-button'>Cancel</button>
            </div>
        </div>
    </div>
  )
